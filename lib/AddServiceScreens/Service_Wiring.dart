...
class ServiceWiring extends StatefulWidget {
  @override
  _ServiceWiringState createState() => _ServiceWiringState();
}

class _ServiceWiringState extends State<ServiceWiring> {
          ...
          children: <Widget>[
            ...
            Container(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    context.read<AuthenticationService>().addWiring(
