...
class ServiceSanitize extends StatefulWidget {
  @override
  _ServiceSanitizeState createState() => _ServiceSanitizeState();
}

class _ServiceSanitizeState extends State<ServiceSanitize> {
