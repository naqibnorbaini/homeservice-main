...
class ServiceGrass extends StatefulWidget {
  @override
  _ServiceGrassState createState() => _ServiceGrassState();
}

class _ServiceGrassState extends State<ServiceGrass> {
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState.validate()) {
                      context.read<AuthenticationService>().addGrass(
