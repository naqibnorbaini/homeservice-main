...
class ServiceWindow extends StatefulWidget {
  @override
  _ServiceWindowState createState() => _ServiceWindowState();
}

class _ServiceWindowState extends State<ServiceWindow> {
          ...
          children: <Widget>[
            ...
            Container(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    context.read<AuthenticationService>().addWindow(
