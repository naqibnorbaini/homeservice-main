...
class ServiceHomeCleaning extends StatefulWidget {
  @override
  _ServiceHomeCleaningState createState() => _ServiceHomeCleaningState();
}

class _ServiceHomeCleaningState extends State<ServiceHomeCleaning> {
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState.validate()) {
                      context.read<AuthenticationService>().addHome(
